...
/*!
    @brief  Class for 8x8 pixel single-color matrices with AliExpress error.
*/
class AliExpress_8x8matrix : public Adafruit_LEDBackpack, public Adafruit_GFX {
public:
  /*!
    @brief  Constructor for 8x8 pixel single-color matrices.
  */
  AliExpress_8x8matrix(void);
